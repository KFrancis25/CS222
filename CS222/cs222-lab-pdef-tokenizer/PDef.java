...
public class PDef {
    ...
    public static void main(String[] args) throws PDefException {
        ...
        Tokenizer tokenStream = new Tokenizer(null, false);
        ...
        // get the first token. while there's another interesting token, print it,
        // and make progress toward termination
        Token t = tins.getNextToken();
